...
public class TestScript06 {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        WebElement Addtocart = driver.findElement(By.xpath("//*[@id=\"item_74854\"]/td[5]/div/button"));
        Addtocart.click();
        
        driver.navigate().back();
        
        WebElement Addtocart2 = driver.findElement(By.xpath("//*[@id=\"item_74969\"]/td[5]/div/button/span/span"));
        Addtocart2.click();
